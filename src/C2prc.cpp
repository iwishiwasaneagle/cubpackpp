...
////////////////////////////////////////////////////////
Parallelogram_Processor::Parallelogram_Processor() : TimesCalled(0), Diffs(2) {}

/////////////////////////////////////////////////////////////
Parallelogram_Processor *Parallelogram_Processor::Descendant() const {
  Parallelogram_Processor *r = new Parallelogram_Processor;
  return r;
}

////////////////////////////////////////////////
void Parallelogram_Processor::Process(Stack<AtomicRegion> &Offspring) {
  TimesCalled++;
  if (TimesCalled == 1) {
  ...
  if (TimesCalled == 2) {
    real NewVolume = Geometry().Volume() / 2;
...
///////////////////////////////////////////////
Processor<Parallelogram> *Parallelogram_Processor::NewCopy() const {
