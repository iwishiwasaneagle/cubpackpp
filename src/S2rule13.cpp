...
static real Type1[] = {0.283402832348840340260055531925e+00,
                       0.649007230578023857142954047869e+00,
                       0.920575474036255978410400945265e+00};
static real Type2[] = {0.677355106028069632559870394597e+00,
                       0.412672216763278882147845015245e+00};
static real Type3[2][2] = {{0.335767600829543545504321849367e+00,
...
static real Weight[7][7] = {
    {0.497326951852944153115255529183e-01, 0.439732090591084987635001867639e-01,
     0.221057969395291114959209696751e-01, 0.138071954801617944635783199052e-01,
     0.478191639416850908138653549756e-01, 0.579302409092634509107760741653e-02,
     0.304879456061841994847272004644e-01},
    //  Nullrule exact for the first 6 basispolynomials,
    {-0.8073879159066197e-02, -0.2498315518214109e-01, 0.5349170539028515e-01,
     0.3595547716318644e-01, 0.4320518775944201e-01, -0.1967607360410405e-01,
     -0.3012159438174910e-01},
    //  Nullrule exact for the first 5 basispolynomials,
    {0.2175100120594341e-01, -0.7117820786684134e-01, 0.1801191272610644e-01,
     -0.1775642346529020e-01, -0.2754333027079005e-02, -0.1170796597217573e-01,
     0.3767099118575607e-01},
    //  Nullrule exact for the first 4 basispolynomials,
    {0.2413156434309756e-01, 0.2327141313816948e-01, 0.3438009174891747e-01,
     0.3084063431284037e-01, -0.6858211678704531e-01, -0.2561913343310581e-01,
     0.3598340055116032e-02},
    //  Nullrule exact for the first 3 basispolynomials,
    {-0.4853627844062673e-01, 0.3645578330411178e-01, 0.4003943562394422e-01,
     -0.4494496660283691e-01, 0.1266357696444992e-01, -0.2028566592818438e-01,
     0.2244689050366323e-01},
    //  Nullrule exact for the first            2 basispolynomials,
    {-0.2979266039117054e-01, 0.3977474716810517e-02, -0.4396076050818155e-01,
     0.5463380585542593e-01, 0.1777067704103634e-01, -0.2876745680547196e-01,
     0.2745318844851159e-01},
    //  Nullrule exact for the first            1 basispolynomials,
    {0.6246499865107039e-01, 0.2624836264288300e-01, -0.1903648724133519e-01,
     -0.2649038633167001e-01, 0.3481279195257287e-01, -0.3459307949232926e-01,
     -0.4406560344431272e-02}};
//
// The error estimator constants
//

void Circle_Rule13::Apply(Integrand &F, Circle &R, real &TheResult,
                          real &TheError) {
  ...
  for (Type = 0; Type <= 3; Type++) {
    for (nr = 0; nr < K[Type]; nr++) {
      if (Type == 0) {
        ...
        Point z1(R.Radius() * Type1[nr], 0), z2(0, R.Radius() * Type1[nr]);
        number = 4;
        x[0] = R.Center() + z1;
        x[1] = R.Center() - z1;
        x[2] = R.Center() + z2;
...
/// ///////////////////////////////////////////
Circle_Rule13::Circle_Rule13() : Rule<Circle>() {}
///////////////////////////////////////////
} // namespace cubpackpp
