...
namespace cubpackpp {
////////////////////////////////////////////
PolarRectangle::PolarRectangle(const Point &A, const Point &B, const Point &C)
    : Geometry(2) {
  if (C == B) {
    TheCenter = A;
  } else {
  ...
  if (TheBigAngle <= TheSmallAngle)
    TheBigAngle += 2 * M_PI;
}

///////////////////////////////////////////////////
PolarRectangle::PolarRectangle(const Point &O, real r1, real r2, real t1,
                               real t2)
    : Geometry(2) {
  TheCenter = O;
  if (r1 > r2) {
...
real PolarRectangle::InnerRadius() const { return TheInnerRadius; }

////////////////////////////////////////////////////
real PolarRectangle::OuterRadius() const { return TheOuterRadius; }

///////////////////////////////////////////////////
real PolarRectangle::SmallAngle() const { return TheSmallAngle; }

/////////////////////////////////////////////////////
real PolarRectangle::BigAngle() const { return TheBigAngle; }

////////////////////////////////////////////////////
const Point &PolarRectangle::Center() const { return TheCenter; }
////////////////////////////////////////////////////
