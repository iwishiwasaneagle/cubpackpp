...
namespace cubpackpp {
///////////////////////////////////////////////////
void REGION_COLLECTION::LocalIntegrand(Integrand *ip) {
...
///////////////////////////////////////////////////
void REGION_COLLECTION::LocalIntegrand(Function f) {
  LocalIntegrand(new Integrand(f));
}

///////////////////////////////////////////////////
REGION_COLLECTION &REGION_COLLECTION::operator+=(const COMPOUND_REGION &C) {
...
///////////////////////////////////////////////////
REGION_COLLECTION::REGION_COLLECTION() : COMPOUND_REGION() {
...
//////////////////////////////////////////////////////
void REGION_COLLECTION::Preprocess() {
  SCR_ptr->IteratorReset();
  while (!SCR_ptr->IteratorAtEnd()) {
...
////////////////////////////////////////////////////
void REGION_COLLECTION::Improve() {
  ...
  LocalInfo().Integral() -= MaxCompoundErrorAtRegion->Integral();
  LocalInfo().AbsoluteError() -= MaxCompoundErrorAtRegion->AbsoluteError();
...
/////////////////////////////////////////////////////
real REGION_COLLECTION::MaxAtomicError() const {
  real MaxError = 0;
  SCR_ptr->IteratorReset();
  while (!SCR_ptr->IteratorAtEnd()) {
...
/////////////////////////////////////////////////////
COMPOUND_REGION *REGION_COLLECTION::NewCopy() const {
